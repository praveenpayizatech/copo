                ...
                <div class="content-area card">
                    <div class="card-innr">
                        ...
                        <div class="card-text ico-setting setting-token-details">
                            ...
                            <form action="{{ route('admin.ajax.stages.settings.update') }}" method="POST" id="stage_setting_details_form1" class="validate-modern">
                                @csrf
                                ...
                                <div class="gaps-1x"></div>
                                <div class="d-flex">
                                    <button class="btn btn-primary " type="submit" ><i class="ti ti-reload"></i><span>Update</span></button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="card-text ico-setting setting-token-purchase">
                            ...
                            <form action="{{ route('admin.ajax.stages.settings.update') }}" method="POST" id="stage_setting_purchase_form1" class="validate-modern">
                                @csrf
                        ...
                        <div class="card-text ico-setting setting-ico-userpanel">
                            ...
                            <div class="gaps-1x"></div>
                            <form action="{{ route('admin.ajax.stages.settings.update') }}" method="POST" id="upanel_setting_form1" class="validate-modern">
                                @csrf
