    ...
    <div class="modal-dialog modal-dialog-md modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="popup-body popup-body-md">
                ...
                <form action="{{ route('admin.ajax.users.add') }}" method="POST" class="adduser-form validate-modern" id="addUserForm1" autocomplete="false">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
    ...
    <div class="modal-dialog modal-dialog-md modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="popup-body popup-body-md">
                ...
                <form class="validate-modern" id="emailToUser1" action="{{ route('admin.ajax.users.email') }}" method="POST" autocomplete="off">
                    @csrf
