                    ...
                    <div class="card-innr"> 
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="accountInfo">
                                <div class="w-xl-16x">
                                    <form action="{{ route('admin.ajax.profile.update') }}" method="POST" id="user_account_update1">
                                        @csrf
                            ...
                            <div class="tab-pane fade" id="secutity">
                                <div class="w-xl-16x">
                                    ...
                                    <form action="{{ route('admin.ajax.profile.update') }}" method="POST" id="security1">
                                        @csrf
                            ...
                            <div class="tab-pane fade" id="changePassword">
                                <div class="w-lg-12x">
                                    <form action="{{ route('admin.ajax.profile.update') }}" method="POST" id="pwd_change1" class="validate-modern">
                                        @csrf
