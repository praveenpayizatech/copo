                    ...
                    <div class="card-innr">
                        ...
                        <div class="tab-content" id="website-setting">
                            <div class="tab-pane fade show active " id="siteinfo">
                                <form action="{{ route('admin.ajax.settings.update') }}" class="validate-modern" method="POST" id="update_settings1">
                                    @csrf
                                    ...
                                    <div class="d-flex">
                                        <button type="submit" class="btn btn-primary " ><i class="ti ti-reload mr-2"></i>Update</button>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="social_links">
                                <form action="{{ route('admin.ajax.settings.update') }}" class="validate-modern" method="post" id="update_social_settings1">
                                    @php
                            ...
                            <div class="tab-pane fade" id="social_api">
                                <form action="{{ route('admin.ajax.settings.update') }}" method="post" class="validate-modern" id="update_api_settings1" autocomplete="off">
                                    @csrf
                            ...
                            <div class="tab-pane fade" id="custom_code">
                                <form action="{{ route('admin.ajax.settings.update') }}" method="post" class="validate-modern" id="update_code_settings1" autocomplete="off">
                                    @csrf
