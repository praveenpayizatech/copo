    ...
    <div class="container">
        <div class="card content-area">
            <div class="card-innr">
                    ...
                    <div class="d-flex guttar-15px">
                        ...
                        <div class="fake-class">
                            <form action="{{ route('admin.ajax.stages.active') }}" method="POST">
                                @csrf
                                <a href="javascript:void(0);" id="update_stage1" data-type = "active_stage" data-id="{{$ico->id}}" class="btn btn-icon btn-sm btn-{{(get_setting('actived_stage') == $ico->id)?'danger ':'danger-alt'}}"><em class="fas fa-star"></em></a>
                ...
                <div class="tab-content" id="ico-details1">
                    <div class="tab-pane fade show active" id="ico_stage1">
                        <form action="{{ route('admin.ajax.stages.update') }}" class="_reload validate-modern1" method="POST" id="ico_stage1" autocomplete="off">
                            @csrf
                            <input type="hidden" name="ico_id" value="{{ $ico->id }}">
                            <div id="stageDetails1" class="wide-max-md">
                                {{-- Stage Details Form --}}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-item input-with-label">
                                           ...
                                           <div class="input-wrap">
                                            <input class="input-bordered" type="text" min="1" name="total_tokens" value="{{ $ico->total_tokens }}" required  >
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-item input-with-label">
                                           ...
                                           <div class="input-wrap">
                                            <input class="input-bordered" type="text" min="0" name="base_price" value="{{ $ico->base_price }}" required>
                                            </div>
                                        ...
                                        <div class="input-item input-with-label">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <div class="relative">
                                                       <div class="input-wrap">
                                                        <input class="input-bordered" type="text" placeholder="Min" name="min_purchase" min="1" value="{{ $ico->min_purchase }}">
                                                   </div>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="relative">
                                                       <div class="input-wrap">
                                                        <input class="input-bordered" type="text" placeholder="Max" name="max_purchase" min="1" max="{{$ico->total_tokens}}" value="{{ $ico->max_purchase }}">
                                                    </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                    ...
                    <div class="tab-pane fade" id="ico_stage_price">
                        <form class="form-wrap w-xl-16x validate-modern" action="{{ route('admin.ajax.stages.meta.update') }}" method="POST" id="ico_stage_price1" autocomplete="off">
                            @csrf
                   ...
                   <div class="tab-pane fade" id="ico_stage_bonus">
                    <form action="{{ route('admin.ajax.stages.meta.update') }}" class="validate-modern" method="POST" id="ico_stage_bonus1" autocomplete="off">
                        @csrf
