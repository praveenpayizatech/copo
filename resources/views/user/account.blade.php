    ...
    <div class="card-innr">
        ...
        <div class="tab-content" id="profile-details">
            <div class="tab-pane fade show active" id="personal-data">
                <form class="validate-modern" action="{{ route('user.ajax.account.update') }}" method="POST" id="nio-user-personal1" autocomplete="off">
                    @csrf
            ...
            <div class="tab-pane fade" id="settings">
                <form class="validate-modern" action="{{ route('user.ajax.account.update') }}" method="POST" id="nio-user-settings1">
                    @csrf
            ...
            <div class="tab-pane fade" id="password">
                <form class="validate-modern" action="{{ route('user.ajax.account.update') }}" method="POST" id="nio-user-password1">
                    @csrf
    ...
    <div class="modal-dialog modal-dialog-md modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="popup-body">
                ...
                <form class="validate-modern" action="{{ route('user.ajax.account.update') }}" method="POST" id="nio-user-2fa1">
                    @csrf
