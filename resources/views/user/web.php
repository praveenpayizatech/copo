...
Route::prefix('user')->middleware(['auth', 'user', 'verify_user', 'g2fa'])->name('user.')->group(function () {
    ...
    // gateway 
    Route::post("/f-request",'User\floxypay@request');
    Route::get("/fresponse",'User\floxypay@gatewayResponse');
...
Route::prefix('admin')->middleware(['auth', 'admin', 'g2fa'])->name('admin.')->group(function () {
    ...
    Route::post("/f-request",'App\Http\Controllers\Admin\floxypay@request');
    Route::get("/fresponse",'App\Http\Controllers\Admin\floxypay@gatewayResponse');
    /* Admin Ajax Route */ 
    Route::name('ajax.')->prefix('ajax')->group(function () {
        ...
        Route::post('/languages', 'Admin\LanguageController@language_action')->name('lang.action'); // v1.1.3
        Route::post('/languages/translate', 'Admin\LanguageController@language_action')->name('lang.translate.action'); // v1.1.3
    });
